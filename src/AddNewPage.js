...
const AddNewPage = () => {
  return (
    ...
    <img  src='images\HobbyCue Logo v2 1.png' className='logo1' />
    ...
    <img src='images\Ellipse 23.png' className='profile-img' /> <FontAwesomeIcon className='down' icon={faChevronDown}/>
